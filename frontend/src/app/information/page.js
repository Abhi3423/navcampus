            ...
            <Card className="mb-4 shadow-xl rounded-2xl">
                <div className="p-6">
                    ...
                    <p className="text-base text-gray-700">
                        This system provides seamless navigation across both indoor and outdoor campus environments. It integrates openstreet for outdoor map paths and indoor positioning. The core pathfinding logic is powered by a hybrid RRT-Connect + Dijkstra&rsquo;s algorithm.
                    </p>
                </div>
            </Card>
            ...
            <Card className="mb-4 shadow-xl rounded-2xl">
                <div className="p-6">
                    ...
                    <ul className="list-disc ml-6 text-base text-gray-700">
                        ...
                        <li>Dijkstra&rsquo;s algorithm computes the shortest path dynamically.</li>
